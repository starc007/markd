...
export function TagPicker({
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="absolute right-0 top-8 z-50 max-h-64 w-48 overflow-y-auto rounded-lg border border-line bg-bg p-1 shadow-lg shadow-black/8 dark:shadow-black/40">
          {registry.length === 0 ? (
            ...
            registry.map((tag) => {
              ...
              return (
                ...
                >
                  ...
                  {on && <Check size={13} strokeWidth={2.5} className="shrink-0 text-ink" />}
                </button>
              );
            })
          )}
