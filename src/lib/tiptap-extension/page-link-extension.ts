...
export const PageLinkExtension = Node.create<PageLinkOptions>({
  ...
  addNodeView() {
    return ({ node }) => {
      ...
      dom.className =
        "page-link inline-flex items-center gap-1 hover:bg-primary/5 pr-2 py-0.5 w-full rounded text-primary hover:text-primary/80 transition-colors cursor-pointer font-medium";
