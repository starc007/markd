...
You are helping build a macOS-first, local-only, ultra high-performance notes app using Tauri.

This app is designed for developers and content creators who care deeply about speed, privacy, and data ownership.
...
The app is not designed for teams, students, or collaborative workflows.
