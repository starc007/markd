...
impl Database {
    ...
    fn initialize(&self) -> Result<()> {
        ...
        // Add content column if it doesn't exist (migration for existing databases)
        let _ = conn.execute("ALTER TABLE notes ADD COLUMN content TEXT NOT NULL DEFAULT '{\"type\":\"doc\",\"content\":[]}'", []);
