...
export function DownloadButton({ label = "Download for macOS" }: { label?: string }) {
  return (
    <motion.a
      href={DMG}
      whileHover={{ y: -2 }}
      ...
      className="group relative inline-flex items-center gap-2.5 overflow-hidden rounded-xl bg-invert px-5 py-3 text-[15px] font-medium text-invert-ink"
    >
      {/* accent sheen sweeping across on hover */}
